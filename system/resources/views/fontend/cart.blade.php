                        ...
                        <table class="cart-table">
                            ...
                            <tbody>
                                <tr class="table-body-row">
                                    ...
                                    <td class="product-image"><img src="{{ url('public') }}/assets/img/products/product-img-1.jpg" alt=""></td>
                                ...
                                <tr class="table-body-row">
                                    <td class="product-remove"><a href="#"><i class="far fa-window-close"></i></a></td>
                                    <td class="product-image"><img src="{{ url('public') }}/assets/img/products/product-img-2.jpg" alt=""></td>
                                ...
                                <tr class="table-body-row">
                                    <td class="product-remove"><a href="#"><i class="far fa-window-close"></i></a></td>
                                    <td class="product-image"><img src="{{ url('public') }}/assets/img/products/product-img-3.jpg" alt=""></td>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <p>Copyrights &copy; 2022 - <a href="https://imransdesign.com/">Irsyad husain j</a>, All Rights Reserved.</p>
                </div>
